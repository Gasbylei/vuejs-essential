    ...
    <div class="container">
      <div class="row footer-top">
        <div class="col-sm-5 col-lg-5">
          ...
          <div class="text-md">
            <a v-for="item in contacts" v-title="item.title" :href="item.link" :style="contactStyle" target="_blank" :key="item.id">
    ...
    return {
      ...
      contacts: [
        {
          icon: 'envelope',
          title: '反馈问题',
          link: 'mailto:gasbylei@foxmail.com'
        },
        {
          icon: 'weibo',
          title: '站长微博',
      ...
      designer: `
        <span style="font-size:0.9em">Designed by
          ...
          <a href="https://github.com/gasbylei"target="_blank"style="color:inherit">Gasbylei</a>
        </span>
      `,
      sponsor: {
        title: '赞助商',
